...
class ParallelDataManager(DataManager, Generic[TDataset]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.load_dir is not None:
            ...
            assert os.path.exists(occupancy_path), "object_occupancy.npy does not exist, consider running get_plane.py"
    ...
    def next_train(self, step: int) -> Tuple[RayBundle, Dict]:
        ...
        if self.load_dir is not None:
            # print("\n\n\n")
            # print(f"ray_bundle.nears before modification: {ray_bundle.nears}")
